...
5. En la carpeta src, crear un archivo python agregar el código creado por el profesor con terminacion.py
...
6. Empezamos con el git add src 

7. Agregamosn el git commit -m "Se agrego src donde esta el codigo python
...
10. en el repositorio mi_proyecto 
...
17. Agrego images que relacionadas con el proyecto

# SUBO CAMBIOS PARA CORREGIR EL PROYECTO 
